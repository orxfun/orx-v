...
fn d2_nvec_vec_vec() {
    ...
    assert_eq!(d2_get_24(&vec.as_slice()), Some(42));
    ...
    assert_eq!(d2_get_24(&vec_refs.as_slice()), Some(&42.to_string()));
}
...
fn d3_nvec_vec_vec() {
    ...
    assert_eq!(d3_get_024(&vec.as_slice()), Some(42));
    ...
    let vec_refs: Vec<Vec<Vec<_>>> = vec_string
        ...
        .collect();
    assert_eq!(d3_get_024(&vec_refs.as_slice()), Some(&42.to_string()));
}
